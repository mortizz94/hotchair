...
export default function TimeTracking() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center font-sans selection:bg-purple-500/30 p-6 md:p-10 relative overflow-hidden">
